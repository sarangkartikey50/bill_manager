...
import { MONTHLY_BUDGET } from 'constants/billManager';
...
const TimeSeriesChart = ({ data }) => {
  ...
  return (
    <div ref={containerRef} className={styles.container}>
      <div className={styles.header}>Monthly Analysis</div>
      <div className={styles.wrapper}>
        ...
        >
          ...
          <Tooltip />
          <Legend />
          <ReferenceLine y={MONTHLY_BUDGET} label='Budget' stroke='red' />
          <Line
            type='monotone'
            dataKey='amount'
            stroke='#8884d8'
